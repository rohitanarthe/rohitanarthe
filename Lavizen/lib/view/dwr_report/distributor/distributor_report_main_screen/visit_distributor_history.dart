...
class DealerVisitView extends StatelessWidget {
  final DealerVisitController controller = Get.put(DealerVisitController());
            ...
            child: Obx(() {
              if (controller.isLoading.value) {
                return Center(child: CircularProgressIndicator());
                  ...
                  .dealerVisitHistory.value.viewDealerVisitList.isEmpty) {
                return Center(child: Text('No data available'));
              } else {
                return DealerHistoryCardWidget(
                  visits: controller.dealerVisitHistory.value.viewDealerVisitList,
                );
              }
            }),
          ),
