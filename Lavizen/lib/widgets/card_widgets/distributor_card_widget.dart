...
import 'package:lavizen/view/dwr_report/distributor/add_distributor_report/add_distributor_report.dart';
...
class DistributorCard extends StatelessWidget {
  ...
  DistributorCard({this.number, this.name, this.owner, this.address,this.custId});
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AddDistributorReport(custId: custId.toString(),)));
                  },
